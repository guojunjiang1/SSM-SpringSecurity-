				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							<c:if test="${pageInfo.pageSize==11}">
								<option>8</option>
								<option>9</option>
								<option>10</option>
								<option selected="true">11</option>
								<option>12</option>
							</c:if>
							<c:if test="${pageInfo.pageSize==12}">
								<option>8</option>
								<option>9</option>
								<option>10</option>
								<option>11</option>
						...
						<ul class="pagination">
							...
							<c:forEach begin="1" end="${pageInfo.pages}" var="user">
								<c:if test="${pageInfo.pageNum == user}">
									<li class="active">
										<a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${user}&size=${pageInfo.pageSize}">${user}</a>
									</li>
								</c:if>
								<c:if test="${pageInfo.pageNum != user}">
									<li>
