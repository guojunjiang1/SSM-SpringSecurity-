					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNum"
								   required="true" placeholder="产品编号" value="" >
						</div>
						<div class="col-md-2 title">产品名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productName"
								   required="true" placeholder="产品名称" value="">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									   required="true" id="datepicker-a3" name="departureTime">
							</div>
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="cityName"
								   required="true" placeholder="出发城市" value="">
						</div>

						<div class="col-md-2 title">产品价格</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="产品价格"
								   required="true" name="productPrice" value="">
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息"
									  required="true" name="productDesc"></textarea>
						</div>
