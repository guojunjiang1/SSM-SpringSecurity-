				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" id="re">
							...
							<!--数据列表-->
							<form action="delete.do" method="post" id="from">
							<table id="dataList"
									...
									<c:forEach items="${pageInfo.list}" var="product">
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" id="xg" onclick="location.href='findById.do?id=${product.id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<c:if test="${pageInfo.pageNum == i}">
										<li class="active">
											<a href="${pageContext.request.contextPath}/product/findAll.do?page=${i}&size=${pageInfo.pageSize}">${i}</a>
										</li>
									</c:if>
									<c:if test="${pageInfo.pageNum != i}">
										<li>
								...
								<li>
									<a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Previous">尾页</a>
								</li>
							</ul>
						</div>
