									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/roleUpPermission.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="user">
									<c:if test="${pageInfo.pageNum == user}">
										<li class="active">
											<a href="${pageContext.request.contextPath}/role/findAll.do?page=${user}&size=${pageInfo.pageSize}">${user}</a>
										</li>
									</c:if>
									<c:if test="${pageInfo.pageNum != user}">
										<li>
