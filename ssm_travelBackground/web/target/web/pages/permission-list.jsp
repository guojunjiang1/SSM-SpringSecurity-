							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_asc_disabled">权限的路径</th>
									...
									<c:forEach items="${pageInfo.list}" var="p">
										<tr>
											...
											<td class="text-center">
												<a href="#" class="btn bg-olive btn-xs">权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="user">
									<c:if test="${pageInfo.pageNum == user}">
										<li class="active">
											<a href="${pageContext.request.contextPath}/permission/findAll.do?page=${user}&size=${pageInfo.pageSize}">${user}</a>
										</li>
									</c:if>
									<c:if test="${pageInfo.pageNum != user}">
										<li>
